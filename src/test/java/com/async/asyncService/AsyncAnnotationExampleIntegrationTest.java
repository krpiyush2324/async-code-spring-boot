...
import com.async.config.SpringAsyncConfig;
...
//		System.out.println("Start - invoking an asynchronous method with void return type " + Thread.currentThread().getName());
//		asyncAnnotationExample.asyncMethodWithVoidReturnType();
//		System.out.println("End - invoking an asynchronous method with void return type ");
//	}
//
//	@Test
//	public void testAsyncAnnotationForMethodsWithReturnType() throws InterruptedException, ExecutionException {
//		System.out.println("Start - invoking an asynchronous method with return type " + Thread.currentThread().getName());
//		final Future<String> future = asyncAnnotationExample.asyncMethodWithReturnType();
//
//		System.out.println("return from future class " + future.get());
//
//		while (true) {
//			if (future.isDone()) {
