...
import com.async.model.EmployeeAddress;
import com.async.model.EmployeeAddresses;
import com.async.model.EmployeeName;
...
public class EmployeeDataController {
	 ...
	 @RequestMapping(value = "/addresses", method = RequestMethod.GET)
	    ...
	    {
	          System.out.println("get addresses Start");
	    ...
	    {
	          System.out.println("get phones Start");
	    ...
	    {
	          System.out.println("get names Start");
